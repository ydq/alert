...
!function($){
	...
	$.confirm=function(){
		...
		if(args.length){
			...
			d.close=function(){$.fn.fadeOut?d.fadeOut('fast',function(){d.remove();}):d.remove();delete $.loaded;}//兼容Zepto默认没有FX模块的关闭动画
